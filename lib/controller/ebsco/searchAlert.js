...
export const postSearchAlert = function* postSearchAlert() {
    const { historyId, userId, frequence } = yield body(this);
    ...
    yield this.historyQueries.updateOne(historyId, { has_alert: true });

    yield this.searchAlertQueries.insertOne(alert);
