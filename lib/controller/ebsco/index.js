...
import {
    articleRetrieve,
    batchArticleRetrieve,
    articleRetrievePure,
} from './articleRetrieve';
import {
    publicationRetrieve,
    publicationRetrievePure,
} from './publicationRetrieve';
...
if (pureRoute) {
    app.use(
        route.get(
            '/:domainName/publication/search/pure',
            publicationSearchPure,
        ),
    );
}
...
app.use(
    route.post('/:domainName/article/batch_retrieve', batchArticleRetrieve),
);
app.use(
...
if (pureRoute) {
    ...
    app.use(
        route.get(
            '/:domainName/article/retrievePure/:dbId/:an',
            articleRetrievePure,
        ),
    );
    app.use(
        route.get(
            '/:domainName/publication/retrieve/pure/:id',
            publicationRetrievePure,
        ),
    );
}
