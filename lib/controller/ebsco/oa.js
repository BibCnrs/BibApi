...
export const redirectOA = function*() {
    ...
    const institute = yield this.instituteQueries.selectOne({
        id: instituteId,
    });
    const unit = yield this.unitQueries.selectOne({ id: unitId });
    ...
    httpLogger.info('open access', {
        ...
        O: user.cnrs ? (user.cnrs == true ? 'CNRS' : 'OTHER') : 'UNKNOWN',
