    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="ask-account">
                    <a href="https://sesame.cnrs.fr" target="blank">${text.askAccount}</a>
                </p>
                        ...
                        <div class="panel-body">
                            <form  class="form-signin" role="form" method="post">
                                ...
                                <div class="form-group">
                                    <label class="control-label" for="username">${text.login}</label>
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary btn-block">${text.connection}</button>
                                </div>
                            </form>
                        </div>
                    </div>
