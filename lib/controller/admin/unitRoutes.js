    ...
    route.get('/', function* () {
        ...
        if (filters) {
            ...
            filters = transformFilters(filters, [
                ...
                { field: 'unit_community.community_id', mode: 'equals', excludeMatch: true },
                { field: 'unit_institute.institute_id', mode: 'equals', excludeMatch: true },
                { field: 'unit_section_cn.section_cn_id', mode: 'equals', excludeMatch: true },
            ]);
        }
