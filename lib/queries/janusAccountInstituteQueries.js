...
const batchUpsert = batchUpsertQuery('janus_account_institute', ['institute_id', 'janus_account_id'], ['institute_id', 'janus_account_id', 'index'], ['institute_id', 'janus_account_id', 'index']);
