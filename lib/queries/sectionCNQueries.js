import { crudQueries, selectPageQuery, selectByOrderedFieldValuesQuery } from 'co-postgres-queries';
...
const selectByIds = selectByOrderedFieldValuesQuery('section_cn', 'id', ['id', 'code', 'name']);
const selectBy = selectPageQuery('section_cn', ['name'], ['id', 'code', 'name']);

const primaryInstitutesJoin = ('LEFT JOIN section_cn_primary_institute AS primary_institute ON primary_institute.section_cn_id = section_cn.id');
const secondaryInstitutesJoin = 'LEFT JOIN section_cn_secondary_institute AS secondary_institute ON secondary_institute.section_cn_id = section_cn.id';
