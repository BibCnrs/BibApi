...
const selectOneByUsername = selectOneQuery('inist_account', ['username'], [
    ...returnFields,
...
const selectEzTicketInfoForId = selectOneQuery('inist_account', ['id'], [
    'username',
...
const batchUpsertPerUsername = batchUpsertQuery('inist_account', ['username'], [
    'username',
    'password',
    'name',
    'firstname',
...
const mainInstituteJoin = 'LEFT JOIN institute main_institute ON (main_institute.id = inist_account.main_institute)';
...
const mainUnitJoin = 'LEFT JOIN unit AS main_unit ON (main_unit.id = inist_account.main_unit)';
