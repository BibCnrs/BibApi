...
export default (queriesFactory, availableMethods = ['GET', 'POST', 'PUT', 'DELETE']) => {
    ...
    app.use(koaRoute.get('/', function* () {
        ...
        const excludedQueryParams = ['limit', 'offset', '_filters', '_sort', '_sortDir'];
        const other = {};
        ...
        this.body = yield queries.selectPage(limit, offset, filters, query._sort, query._sortDir, other);
