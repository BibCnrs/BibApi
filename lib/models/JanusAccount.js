    ...
    const updateOne = function* (selector, janusAccount) {
        try {
            ...
            if (janusAccount.communities) {
                communities = yield updateCommunities(janusAccount.communities, updatedUser.id);
            }
            if (janusAccount.additional_institutes) {
                additional_institutes = yield updateAdditionalInstitutes(janusAccount.additional_institutes, updatedUser.id);
            }
            if (janusAccount.additional_units) {
                additional_units = yield updateAdditionalUnits(janusAccount.additional_units, updatedUser.id);
            }
