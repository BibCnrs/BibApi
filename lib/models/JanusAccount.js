  ...
  const selectAllForExport = function*() {
    ...
    dataForExport.forEach(element => {
      ...
      if (object) {
        ...
        if (element.additional_institutes) {
          object.additional_institutes.push(element.additional_institutes);
        }
      } else {
        if (element.additional_units) {
        ...
        if (element.additional_institutes) {
          element.additional_institutes = [element.additional_institutes];
        } else {
          element.additional_institutes = [];
        }
