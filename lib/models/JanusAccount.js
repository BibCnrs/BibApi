    ...
    const selectAllForExport = function*() {
        ...
        const dataForExport = yield client.query({
            sql: `SELECT janus_account.id, janus_account.uid, janus_account.name, janus_account.firstname,
              ...
              institute.code AS primary_institute,
              ...
              LEFT JOIN janus_account_community ON (janus_account.id = janus_account_community.janus_account_id)
              LEFT JOIN community ON (janus_account_community.community_id = community.id)
