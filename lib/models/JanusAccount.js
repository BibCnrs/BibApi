...
const upsertOnePerUidQuery = upsertOneQuery(
    'janus_account',
    ['uid'],
...
const selectOneByUidQuery = selectOneQuery('janus_account', ['uid'], [
    ...returnFields,
...
const selectEzTicketInfoForIdQuery = selectOneQuery('janus_account', ['id'], [
    'mail',
    'cnrs',
...
export default (client) => {
    ...
    const queries = client.link(janusAccountQueries);
    ...
    queries.upsertOnePerUid = client.link(upsertOnePerUidQuery);
    const baseSelectEzTicketGroupForId = client.link(selectEzTicketInfoForIdQuery);
    const baseSelectOneByUid = client.link(selectOneByUidQuery);
