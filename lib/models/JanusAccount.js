...
export const getJanusAccounts = function* () {
    const janusAccounts = yield prisma.janus_account.groupBy({
        by: ['id'],
    });
...
export const insertOne = function* insertOne(janusAccount) {
    const { additional_units: additionalUnits, ...janusAccountWithoutAdditionalUnits } = janusAccount;
...
export const getSimilarUid = function* getSimilarUid(uid) {
