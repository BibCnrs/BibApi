...
const communityQueries = crud('community', ['name', 'gate', 'user_id', 'password', 'profile', 'ebsco'], ['id'], ['id', 'name', 'gate', 'user_id', 'password', 'profile', 'ebsco'], []);
...
const selectByIdsQuery = selectByOrderedFieldValues('community', 'id', ['id', 'name', 'gate', 'user_id', 'password', 'profile', 'ebsco']);
