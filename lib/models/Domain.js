...
const domainQueries = crud('domain', ['name', 'gate', 'user_id', 'password', 'profile', 'ebsco'], ['name'], ['id', 'name', 'gate', 'user_id', 'password', 'profile', 'ebsco'], []);
const selectOneByNameQuery = selectOne('domain', ['name'], ['*']);
const selectOneByGateQuery = selectOne('domain', ['gate'], ['*']);
const selectByNamesQuery = selectByOrderedFieldValues('domain', 'name', ['id', 'name', 'gate', 'user_id', 'password', 'profile', 'ebsco']);
