...
const selectByUnitQuery = selectPage(
...
export default (client) => {
    ...
    const selectByUnit = selectByUnitQuery(client);
    ...
    queries.selectByUnit = function* (unit) {
        return yield selectByUnit(null, null, { unit_id: unit.id }, 'name', 'ASC');
    };
