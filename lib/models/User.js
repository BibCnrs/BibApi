...
schema.virtual('institutes').get(function () {
    return (this.primaryInstitute ? [this.primaryInstitute] : []).concat(this.additionalInstitutes || []);
});

schema.virtual('units').get(function () {
    return (this.primaryUnit ? [this.primaryUnit] : []).concat(this.additionalUnits || []);
});
