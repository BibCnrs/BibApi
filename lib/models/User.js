...
export default (client) => {
    ...
    queries.insertOne = function* insertOne(user) {
        try {
            ...
            const additional_institutes = yield queries.updateInstitutes(user.additional_institutes, insertedUser.id);
    ...
    queries.updateOne = function* (selector, user) {
        try {
            ...
            const additional_institutes = yield queries.updateInstitutes(user.additional_institutes, updatedUser.id);
