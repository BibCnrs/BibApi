...
const unitQueries = crud('unit', ['code', 'comment'], ['id'], ['*'], [
    (queries) => {
...
const upsertOnePerCodeQuery = upsertOne('unit', ['code'], ['comment']);
const selectOneByCodeQuery = selectOne('unit', ['code'], ['id', 'code', `ARRAY(${selectDomains}) AS domains`, 'comment']);
