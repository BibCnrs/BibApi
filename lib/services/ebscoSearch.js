...
export const getEbscoQuery = function getAjaxQuery(query = {}) {
    ...
    return {
        SearchCriteria: {
            Queries: query.queries ? query.queries.map(q =>( {
            ...
            FacetFilters: query.activeFacets ? unparseActiveFacet(query.activeFacets) : [],
...
export default function (api) {
    return function* search(query = {}, sessionToken, authToken) {
        return yield ebscoRequest(`/edsapi/${api}/Search`, getEbscoQuery(query), authToken, sessionToken);
    };
}
