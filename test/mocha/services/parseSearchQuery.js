    ...
    describe('parseMetadoreSearch', () => {
        it('should return expected query string when no currentPage is sent', () => {
            ...
            const expectedQueryString =
                'query=%28*%3A%22search+term%22%29AND%28%28attributes.types.resourceType%3ADataset%29OR%28attributes.types.resourceTypeGeneral%3ADataset%29%29&size=10&page=1';
            assert.equal(
        ...
        it('should return expected query string when a currentPage is sent', () => {
            ...
            const expectedQueryString =
                'query=%28*%3A%22search+term%22%29AND%28%28attributes.types.resourceType%3ADataset%29OR%28attributes.types.resourceTypeGeneral%3ADataset%29%29&size=10&page=3';
            assert.equal(
                parseMetadoreSearch(rawQuery).toString(),
                expectedQueryString,
            );
        ...
        it('should return expected query string when a field is set', () => {
            ...
            const expectedQueryString =
                'query=%28attributes.descriptions.description%3A%22search+term%22%29AND%28%28attributes.types.resourceType%3ADataset%29OR%28attributes.types.resourceTypeGeneral%3ADataset%29%29&size=10&page=1';
            assert.equal(
                parseMetadoreSearch(rawQuery).toString(),
                expectedQueryString,
            );
        ...
        it('should return expected query string when the field is title and term contains one word', () => {
            ...
            const expectedQueryString =
                'query=%28attributes.titles.title%3A*covid*%29AND%28%28attributes.types.resourceType%3ADataset%29OR%28attributes.types.resourceTypeGeneral%3ADataset%29%29&size=10&page=1';
            assert.equal(
                parseMetadoreSearch(rawQuery).toString(),
                expectedQueryString,
            );
        ...
        it('should return expected query string when the field is title and term contains a group of words', () => {
            ...
            const expectedQueryString =
                'query=%28attributes.titles.title%3A*covid*%29AND%28attributes.titles.title%3A*pandemic*%29AND%28%28attributes.types.resourceType%3ADataset%29OR%28attributes.types.resourceTypeGeneral%3ADataset%29%29&size=10&page=1';
            assert.equal(
                parseMetadoreSearch(rawQuery).toString(),
                expectedQueryString,
            );
